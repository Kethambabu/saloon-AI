...
from infrastructure.db.models import BusinessMetricsHistory
...
class ForecastService:
    ...
    def get_forecast_metrics(db: Session) -> Dict[str, Any]:
        ...
        from infrastructure.db.models import Appointment, Lead, CustomerRecommendation, AppointmentStatus, LeadStatus
