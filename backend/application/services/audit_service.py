    ...
    def _write_to_db(self, entry: dict) -> None:
        ...
        try:
            ...
            try:
                ...
                if is_sqlite:
                    # SQLite table creation and insertion (avoids gen_random_uuid() and JSONB)
                    db.execute(text("""
                    ...
                    db.execute(
                        text("""
                            ...
                            VALUES
                                (:id, :audit_id, :timestamp, :user_id, :role, :resource,
                    ...
                    # Ensure table exists (lightweight idempotent DDL for PostgreSQL)
                    db.execute(text("""
                        CREATE TABLE IF NOT EXISTS mcp_audit_logs (
