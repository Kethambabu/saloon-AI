...
_ACTION_PERMISSIONS: Dict[str, Set[str]] = {
    ...
    "staff_get_leaves":            {"STAFF", "MANAGER", "OWNER", "ADMIN"},
    "staff_cancel_leave":          {"STAFF", "MANAGER", "OWNER", "ADMIN"},
    "staff_recommend_services":    {"STAFF", "MANAGER", "OWNER", "ADMIN"},
    "staff_reminders":             {"STAFF", "MANAGER", "OWNER", "ADMIN"},
    "staff_raw_sql":               {"STAFF", "MANAGER", "OWNER", "ADMIN"},
    ...
    "analytics_appointments":      {"MANAGER", "OWNER", "ADMIN"},
    "analytics_leads":             {"MANAGER", "OWNER", "ADMIN"},
    "analytics_services":          {"MANAGER", "OWNER", "ADMIN"},
    "analytics_reviews":           {"MANAGER", "OWNER", "ADMIN"},
    "analytics_upsell":            {"MANAGER", "OWNER", "ADMIN"},
    "analytics_branches":          {"MANAGER", "OWNER", "ADMIN"},
