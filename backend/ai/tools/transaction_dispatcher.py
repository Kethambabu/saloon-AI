...
def execute_transaction(action: str, parameters: Union[Dict[str, Any], str]) -> str:
    ...
    Args:
        action: The name of the transactional action to execute. Must be one of:
            ...
            - 'trigger_returning_cohort_reminders': Manually trigger daily reminders for the returning customer cohort.
    ...
    try:
        ...
        if action_lower == "book_appointment":
            from ai.agents.receptionist_agent import book_new_appointment
            ...
            from ai.agents.receptionist_agent import cancel_existing_appointment
            return cancel_existing_appointment(
                appointment_id=params.get("appointment_id"),
            )

        elif action_lower == "reschedule_appointment":
            from ai.agents.receptionist_agent import reschedule_existing_appointment
        ...
        # CRM & Lead transactions
            ...
            from ai.agents.lead_followup_agent import register_new_lead
            ...
            from ai.agents.lead_followup_agent import advance_lead_status
            ...
            from ai.agents.lead_followup_agent import send_followup_reminder
        ...
        # Review & Reputation transactions
            ...
            from ai.agents.reputation_agent import draft_review_response
            ...
            from ai.agents.reputation_agent import escalate_customer_review
        ...
        # Upsell transactions
            ...
            from ai.agents.upsell_agent import accept_recommendation
            ...
            from ai.agents.upsell_agent import reject_recommendation
        ...
        # Business Intelligence transactions
        elif action_lower == "trigger_returning_cohort_reminders":
            from ai.agents.bi_agent import trigger_returning_cohort_reminders
            return trigger_returning_cohort_reminders()
            ...
            supported = [
                ...
                "reject_upsell_recommendation", "trigger_returning_cohort_reminders"
            ]
