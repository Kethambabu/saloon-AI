...
def search_for_customers(search_query: Optional[str] = None, customer_query: Optional[str] = None) -> str:
    """
    ...
    """
    query = search_query or customer_query or ""
    db = SessionLocal()
    try:
        customers = resolver_search_customers(db, query, limit=10)
