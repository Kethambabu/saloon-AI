...
function AppContent() {
  ...
  // Enforce staff fallback if they somehow select analytics tab
  useEffect(() => {
    if (user && user.role === 'Staff' && activeTab === 'analytics') {
      setActiveTab('chat');
    }
  }, [user, activeTab]);
      ...
      <div className="space-y-8 animate-fade-in text-left">
        ...
        <div className="flex items-center space-x-3 border-b border-slate-200/80 pb-4">
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-sm font-bold tracking-tight transition-all duration-300 flex items-center space-x-2 border cursor-pointer ${
              activeTab === 'chat'
          ...
          >
            ...
            <span>💬 Clara Receptionist</span>
          </button>
          
          {/* Hide Executive Analytics completely for Staff role */}
          {user.role !== 'Staff' && (
            <button
        ...
        {activeTab === 'chat' ? (
          <>
            ...
            <section className="bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700 text-white rounded-3xl p-6 md:p-8 shadow-xl flex flex-col md:flex-row items-center justify-between border border-blue-500/20 relative overflow-hidden text-left">
              ...
              <div className="space-y-3 z-10 text-left max-w-xl">
                ...
                <p className="text-blue-100 text-sm md:text-base font-medium leading-relaxed">
                  Meet Clara, your autonomous salon receptionist. Clara answers client queries, checks real-time calendar availability, books or reschedules services, and updates the database instantly.
                </p>
              </div>
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm flex items-center space-x-4 hover:border-blue-200 hover:shadow-md transition-all duration-300 text-left">
